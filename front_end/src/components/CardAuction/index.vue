          ...
          <div class="mb-8">
              ...
              <div class="product-list grid grid-cols-4 gap-4">
                  <div v-for="(auction, index1) in auctions.content" :key="index1"
                      ...
                      <a-card hoverable @click="selectAuction(auction)" class="h-96">
                        
                          <template #cover>
                              <img :src="auction.productImage" alt="Auction"
              ...
              <CardDetailModal :visible="viewModalVisible1" :auction="selectedAuction"
