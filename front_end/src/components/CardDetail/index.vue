<!-- <template>
   <div v-if="visible" class="z-20 fixed inset-0 bg-gray-800 bg-opacity-50 flex items-center justify-center"
       @click="closeModal">
           ...
           <div class="flex space-x-8">
               <div class="flex-1 relative">
                   <div class="w-full h-64 overflow-hidden rounded-md">
                       <div class="flex-1">
                           <img v-for="(image, index) in images[pos]" :key="index" src='../../assets/images/image1.jpg'
