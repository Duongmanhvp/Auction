      ...
      <div class="w-8/10 flex">
        ...
        <div class="hidden sm:flex items-center justify-center space-x-2 ml-6">
          <a class="ant-dropdown-link font-bold cursor-pointer hover:text-teal-600">
            <router-link to="/admin/auctionManagement" class="block w-full h-full hover:text-teal-600 rounded"
          ...
          <a class="ant-dropdown-link font-bold cursor-pointer hover:text-teal-600">
            <router-link to="/admin/productManagement" class="block w-full h-full hover:text-teal-600 rounded"
              active-class="text-teal-600">
              <div class="w-full h-full p-5 flex items-center justify-center">
                <img src="../../assets/icon/asset-management.svg" alt="Chevron Down" class="h-5 w-5 mr-2" />
                Asset Management
              </div>
            </router-link>
          </a>
